...
[**getTeamMatchesByYearKeys**](TeamApiService.md#getTeamMatchesByYearKeys) | **GET** /team/{team_key}/matches/{year}/keys | Gets a list of match keys for matches for the given team and year.
